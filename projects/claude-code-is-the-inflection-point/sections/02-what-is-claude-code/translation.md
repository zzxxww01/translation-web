...
这既是未来的惊鸿一瞥，也已是今日软件开发的现实。你欣赏的工程师们正在实践 vibe coding（直觉编程/意念编程）：

- Andrej Karpathy 一年前创造了“vibe coding”这一术语，如今正公开讨论这种范式转变。他明确指出：“我已经注意到，自己手动编写代码的能力正逐渐萎缩。生成（写代码）与辨别（读代码）是大脑中两种不同的能力。”

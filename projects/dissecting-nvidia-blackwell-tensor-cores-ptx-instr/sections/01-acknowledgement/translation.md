感谢 Nebius 和 Verda 提供用于微基准测试的 B200 节点。这些节点启用了正确的硬件计数器，使得 NCU性能分析成为可能。对于所用云服务商未启用 NCU 的用户，可以参考 GPU Mode 的 Mark Saroufim 建议的替代方案。此外，我们还要感谢《通过微基准测试与多层次分析剖析 NVIDIA Hopper 架构》与《tcgen05 入门指南》的作者，我们的代码正是基于他们的工作成果编写而成。

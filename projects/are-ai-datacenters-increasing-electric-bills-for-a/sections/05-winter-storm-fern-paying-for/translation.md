...
ERCOT的电网在1月的严寒中经受住了考验。电网运营商发布的天气预警仅停留在预防层面。实际需求低于预测，未触发任何紧急程序，系统维持了充足的备用容量。除了冬季风暴中常见的常规输配电故障外，得州电网未面临任何问题。
...
美国能源部被迫根据《联邦电力法》第 202(c) 条发布紧急命令，授权电网运营商绕过环保限制，调用全国数据中心和工业站点约 35 GW 的备用发电容量——而这些容量原本根本不具备参与基本剩余拍卖（BRA）的资格。

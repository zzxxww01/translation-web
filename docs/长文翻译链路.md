...
| 快捷指令 | ID | 说明 |
| --- | --- | --- |
| **可读性** | `readable` | 从句法结构层面重写译文：控制句长、去被动语态、删冗余连接词、调整中文语序、消除连续"的" |
| **更地道** | `idiomatic` | 从表达层面重写译文：用具体事实代替空泛描述、简化结构、避免同义词循环和公式化开头 |
| **更专业** | `professional` | 提升专业表达：保留判断力度、产品代号保留英文、删除套话、数据段落拆分重组 |

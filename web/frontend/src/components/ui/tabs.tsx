...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 max-w-full items-center justify-start overflow-x-auto rounded-lg border border-slate-200 bg-white p-1 text-slate-500 shadow-none mobile-scrollbar-none",
      className
    )}
    {...props}
  />

...
export function ImportVersionModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="导入参考译文">
      <div className="space-y-4 p-6">
        ...
        <div>
          ...
          >
            <input
              ...
              className="hidden"
            />
            <Upload className="mx-auto mb-2 h-10 w-10 text-text-muted" />
          ...
          <div className="mb-3 flex items-center gap-2">
            ...
            <span className="text-xs text-text-muted">或直接粘贴内容</span>
            <div className="h-px flex-1 bg-border" />
          </div>
        ...
        {markdownContent && (
          <div>
            ...
            <div className="max-h-40 overflow-y-auto rounded-lg bg-bg-tertiary p-3">

...
def create_default_global_glossary() -> Glossary:
    ...
    default_terms = [
        ...
        ("TPU", "TPU", TranslationStrategy.PRESERVE, "保留原文，不解释"),
        ...
        ("Tokenomics", "token 经济学", TranslationStrategy.PRESERVE_ANNOTATE, "首次写“Tokenomics（token 经济学）”，后续保留 Tokenomics"),
        ("agent", "智能体", TranslationStrategy.TRANSLATE, "AI/编程语境中译为“智能体”，不要译为“代理”"),
        ("AI agent", "AI 智能体", TranslationStrategy.TRANSLATE, "不要译为“AI 代理”"),
        ("coding agent", "编程智能体", TranslationStrategy.TRANSLATE, "不要译为“编码代理”"),
        ("coding agents", "编程智能体", TranslationStrategy.TRANSLATE, "复数按中文习惯不加复数标记"),
        ("agentic coding", "智能体编程", TranslationStrategy.FIRST_ANNOTATE, "首次写“智能体编程（agentic coding）”，后续写“智能体编程”"),
        ("agentic benchmark", "智能体基准测试", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("token efficiency", "token 效率", TranslationStrategy.TRANSLATE, "token 保留英文，efficiency 译为效率，不标注英文"),
        ("harness", "harness", TranslationStrategy.PRESERVE, "保留英文原文，不翻译为测试框架"),
        ("vibe coding", "vibe coding", TranslationStrategy.PRESERVE_ANNOTATE, "首次写“vibe coding（氛围式编程）”，后续保留 vibe coding"),
        ("vibe coding startups", "vibe coding 初创公司", TranslationStrategy.PRESERVE_ANNOTATE, "首次写“vibe coding 初创公司（氛围式编程初创公司）”，后续写“vibe coding 初创公司”"),
        ("reasoning effort", "推理强度", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("tool calls", "工具调用", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("tokenizer", "分词器", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("model card", "模型卡", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("rubric", "评分标准", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("rubrics", "评分标准", TranslationStrategy.TRANSLATE, "复数按中文习惯不加复数标记"),
        ("priority tier", "优先层级", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("fast mode", "快速模式", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("rev share", "收入分成", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("wrapper", "wrapper", TranslationStrategy.PRESERVE_ANNOTATE, "首次写“wrapper（包装器）”，后续保留 wrapper"),
        ("wrappers", "wrapper", TranslationStrategy.PRESERVE_ANNOTATE, "首次写“wrapper（包装器）”，后续保留 wrapper；复数不单独体现"),
        ("LLM-as-a-judge", "LLM-as-a-judge", TranslationStrategy.PRESERVE_ANNOTATE, "首次写“LLM-as-a-judge（LLM 评判器）”，后续保留 LLM-as-a-judge"),
        ("LLM judge", "LLM judge", TranslationStrategy.PRESERVE_ANNOTATE, "首次写“LLM judge（LLM 评判器）”，后续保留 LLM judge"),
        ("greenfield", "greenfield", TranslationStrategy.PRESERVE_ANNOTATE, "首次写“greenfield（从零开始）”，后续保留 greenfield"),
        ("jagged frontier", "jagged frontier", TranslationStrategy.PRESERVE_ANNOTATE, "首次写“jagged frontier（锯齿状前沿）”，后续保留 jagged frontier"),
        ("Mtok", "Mtok", TranslationStrategy.PRESERVE_ANNOTATE, "首次写“Mtok（百万 token）”，后续保留 Mtok"),
        ("ARR", "ARR", TranslationStrategy.PRESERVE_ANNOTATE, "首次写“ARR（年度经常性收入）”，后续保留 ARR"),
        ("checkpoint", "checkpoint", TranslationStrategy.PRESERVE, "AI 模型语境保留 checkpoint，不译为检查点"),
        ("KV cache", "KV cache", TranslationStrategy.PRESERVE, "保留英文原文，不解释"),
        ("postmortem", "事后分析报告", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("SKU", "SKU", TranslationStrategy.PRESERVE, "保留英文原文"),
        ("xhigh", "xhigh", TranslationStrategy.PRESERVE, "模型推理强度枚举值，保留原文"),
        ("non-reasoning", "non-reasoning", TranslationStrategy.PRESERVE, "模型推理强度枚举值，保留原文"),
        ("max_tokens", "max_tokens", TranslationStrategy.PRESERVE, "API 参数名，保留原文"),
        ("task budget", "任务预算", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("prompt caching", "提示缓存", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("input/output ratio", "输入/输出比", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("token counting", "token 计数", TranslationStrategy.TRANSLATE, "token 保留英文，counting 译为计数"),
        ("long-horizon", "长时程", TranslationStrategy.TRANSLATE, "用于 long-horizon tasks"),
        ("de facto benchmark", "事实标准基准测试", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("pass-to-pass", "pass-to-pass", TranslationStrategy.PRESERVE, "基准测试指标名，保留原文"),
        ("fail-to-pass", "fail-to-pass", TranslationStrategy.PRESERVE, "基准测试指标名，保留原文"),
        ("human in the loop", "人在回路中", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
        ("single-turn", "单轮", TranslationStrategy.TRANSLATE, "直接翻译，不标注英文"),
